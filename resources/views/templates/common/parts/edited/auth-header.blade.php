    ...
    <div class="center border-0">
        <div class="container">
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <button id="sidebar-toggle" class="border-0 bg-transparent mr-2 mr-lg-4">
                    <span></span>
                    <span></span>
                    <span></span>
                </button>

                <a class="navbar-brand ml-0 ml-md-4" href="/">
                    <img class="d-none d-sm-block" src="https://resusnasiya.uz/img/resus-logo.dcaaeb47.svg">
                    <img class="d-block d-sm-none"
                         src="{{asset('images/logo-test-sm.svg')}}">
                </a>
                ...
                <div class="d-block d-md-none ml-auto mr-0 mr-md-4">
                    @include('templates.common.parts.edited.auth-locale')
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    {{--                            @guest--}}
                    {{--                                <li class="nav-item"><a class="nav-link link-user" href="#" data-toggle="modal"--}}
                    {{--                                                        data-target="#auth">{{__('template.txt_login_buyer')}}</a></li>--}}
                    {{--                                <li class="nav-item"><a class="nav-link link-shop"--}}
                    {{--                                                        href="{{localeRoute('partners.login')}}">{{__('template.txt_login_partner')}}</a>--}}
                    {{--                                </li>--}}
                    {{--                            @endguest--}}
                    {{--                            @auth--}}
                    {{--                                <li class="nav-item"><a class="nav-link link-user"--}}
                    {{--                                                        href="{{localeRoute('cabinet.index')}}">{{__('template.txt_cab')}}</a>--}}
                    {{--                                </li>--}}
                    {{--                                <li class="nav-item"><a class="nav-link link-exit"--}}
                    {{--                                                        href="{{localeRoute('logout')}}">{{__('app.btn_exit')}}</a></li>--}}
                    {{--                            @endauth--}}
                    {{--                            <li class="nav-item cart-item">--}}
                    {{--                                <a class="nav-link link-cart" href="{{localeRoute('cart')}}"--}}
                    {{--                                   role="button">{{__('app.btn_cart')}}&nbsp;(<span--}}
                    {{--                                        class="count"><?=\App\Http\Controllers\Core\CartController::countCartProducts()?></span>)</a>--}}
                    {{--                            </li>--}}
                    {{--                        </ul>--}}
                    {{--                    </div>--}}
                    ...
                    <ul class="d-none d-md-flex navbar-nav ml-auto menu-user">
                        ...
                        {{--                            <a href="/partners" class="nav-link text-dark">--}}
                        {{--                                Магазины--}}
                        {{--                            </a>--}}
                        {{--                        </li>--}}
                        <li class="nav-item">
                        ...
                        {{--                        @endguest--}}
                        @php
                            $localeCode = App\Helpers\LocaleHelper::language()->code;
                            $baseUrl = url()->to('/');
                            $baseUrlWithLocale = $baseUrl . '/' . $localeCode;
                            $currentUrl =  url()->current();
                            $isMatch = $currentUrl === $baseUrlWithLocale;
                        @endphp
                        @if(\Illuminate\Support\Facades\Auth::check() && !$isMatch)
                            <li class="nav-item dropdown">
                                {{--                                <a class="dropdown-item link-exit"--}}
                                {{--                                   href="{{localeRoute('logout')}}"--}}
                                {{--                                >--}}
                                {{--                                    {{__('app.btn_exit')}}--}}
                                {{--                                </a>--}}
                                <a class="nav-link link-user dropdown-toggle" href="#" id="navbarDropdownLogin"
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownLogin">
                                    <a class="dropdown-item link-user"
                                       href="{{localeRoute('cabinet.index')}}"
                                    >
                                        {{__('template.txt_cab')}}
                                    </a>
                                    <a class="dropdown-item link-exit"
                        ...
                        {{--                        <li class="nav-item">--}}
                        {{--                            <a class="nav-link link-cart"--}}
                        {{--                               href="{{localeRoute('cart')}}"--}}
                        {{--                               role="button">--}}
                        {{--                                {{__('app.btn_cart')}}&nbsp;--}}
                        {{--                                (<span class="count"><?=\App\Http\Controllers\Core\CartController::countCartProducts()?></span>)--}}
                        {{--                            </a>--}}
                        {{--                        </li>--}}
                    </ul>
                </div><!-- /.collapse -->
