...
<div class="offer order-block">
    ...
    <div class="hr"></div>
    <div
        class="offer-text">{{__('account.txt_1', ['vendor' => $order->company->name,'buyer' => $order->buyer->fio, 'offer' => $order->id])}}</div>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="part">
                    ...
                    <div class="offer-total">{{$order->contract->deposit}}</div>
                </td>

                <td class="part">
                    <div class="caption">{{__('offer.offer_total')}}</div>
                    <div class="offer-total">{{$order->contract->total + $order->contract->deposit}}</div>
                </td>
            </tr>
        </table>
    </div><!-- /.offer-results -->
