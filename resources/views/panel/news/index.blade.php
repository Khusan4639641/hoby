...
@section('center-header-control')
    <a href="{{localeRoute('panel.news.create')}}" class="btn btn-primary btn-plus">
        {{__('panel/news.btn_add')}}
    </a>
@endsection
...
@section('content')
    ...
    <table class="table news-list">
        <thead>
            <tr>
                <th>{{__('panel/news.date')}}</th>
                <th></th>
                <th>{{__('panel/news.title')}}</th>
                <th></th>
                <th></th>
            </tr>
        </thead>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">{{__('panel/news.header_delete_confirm')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>{{__('panel/news.txt_delete_confirm')}}</p>
                </div>
