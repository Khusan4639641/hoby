    ...
    <div class="pretension-page">
        ...
        <section class="main" style="margin-top: -80px;">
            ...
            {!! __('panel/contract.body', [
                ...
                'expired_days_uz' => '<span class="font-weight-bold">' . $contract->expired_days_uz . '</span>',
                'expired_days_ru' => '<span class="font-weight-bold">' . $contract->expired_days_ru . '</span>',
        ...
        <section class="footer">
            <div class="footer-child">
                ...
                <p>
                    ...
                    <span class="font-weight-bold">{{__('offer.seller_oked')}}: </span>
