    ...
    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
        <table class="table accounts-list dataTable no-footer" id="DataTables_Table_0" role="grid"
            ...
            <tr role="row">
                ...
                <th class="sorting_disabled text-right" rowspan="1" colspan="1"
                    style="width: 343px;">{{ __('Сумма бонусов') }}</th>
                <th class="sorting_disabled text-right" rowspan="1" colspan="1"
                    style="width: 343px;">{{ __('Сумма расходов') }}</th>
                <th class="sorting_disabled text-right" rowspan="1" colspan="1"
                    style="width: 343px;">{{ __('Разница между бонусами и расходами') }}</th>
            </tr>
            </thead>
            <tbody>
            @foreach($users as $user)
                <tr role="row" class="odd">
                    ...
                    <td class="text-right">{{ number_format($user->bonus, 2, ',', ' ') }}</td>
                    <td class="text-right">{{ number_format($user->debit, 2, ',', ' ') }}</td>
