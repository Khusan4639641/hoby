...
@section('content')
    ...
    <div>
        ...
        @if($access == 'recovery' || $access == 'finance' || $access == 'sales_finance' || $access == 'admin')
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select id="report" name="report" v-model="filter.report" class="form-control select-report" @change="reportOnChange()">
                                    <option value=1 url="{{localeRoute( 'panel.reports.'.$model15.'.export', $model15 ) }}">Бухгалтерия c отмененными</option>
                                    ...
                                    <option value=22 url="{{localeRoute( 'panel.reports.'.$model22.'.export', $model22 ) }}">История КУС</option>
                                </select>
                            </div>
                        </div>
