...
return [
    ...
    */
    ...
    'exists_real_error'    => 'Запись с таким :attribute отсутствует в базе.',
    ...
    */
    ...
    'custom' => [
        // Nurlan 25.04.2022
        'user_id_invoice' => [
            'required'          => 'ID пользователя обязательна для заполнения!',
            'unique'            => 'ID пользователя должен быть уникальным в таблице!',
            'numeric'           => 'ID пользователя должно быть целочисленным числом!',
        ],
        'contract_id_invoice' => [
            'required'          => 'ID контракта обязательна для заполнения!',
            'unique'            => 'ID контракта должен быть уникальным в таблице!',
            'numeric'           => 'ID контракта должно быть целочисленным числом!',
        ],
        'fix_inv_number' => [
            'required'          => 'Номер инвойса(фиксированный) обязателен для заполнения!',
            'unique'            => 'Номер инвойса(фиксированный) должен быть уникальным в таблице!',
            'digits_between'    => 'Номер инвойса(фиксированный) должен быть целочисленным числом и быть в промежутке между 14-20 цифрами!',
        ],
        'percent_inv_number' => [
            'required'          => 'Номер инвойса(процент) обязателен для заполнения!',
            'unique'            => 'Номер инвойса(процент) должен быть уникальным в таблице!',
            'digits_between'    => 'Номер инвойса(процент) должен быть целочисленным числом и быть в промежутке между 14-20 цифрами!',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'work_company'          => 'Название места работы',
        'work_phone'            => 'Рабочий телефон',
        'card_number' => "Номер карты",
        'card_valid_date' => "Действительна до",
        'amount' => 'Сумма',
        'uppercase' => 'Поле :attribute должно начинаться с заглавной буквы',
        'lat_only' => 'Поле :attribute заполняется только латиницей',

        'address_registration_region'   =>  'Регион',
        'address_registration_address'  => 'Адрес',
        'address_registration_area'     => 'Район',

        'address_residential_region'    => 'Регион',
        'address_residential_area'      => 'Район',
        'address_residential_address'   => 'Адрес',
    ],
];
