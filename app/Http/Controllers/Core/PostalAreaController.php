...
use App\Models\PostalArea as Model;

class PostalAreaController extends CoreController
{
    private $config;
    ...
    private $validatorRules = [
        ...
        'postal_region_id' => ['nullable', 'integer'],
        'katm_local_region' => ['nullable', 'integer']
    ];

    /**
     * PostalAreaController constructor
     */
    ...
    public function add(Request $request) {
        ...
        if (true) {
            ...
            if ($validator->fails()) {
                ...
                $region->katm_local_region = $request->katm_local_region;
                $region->postal_region_id = $request->postal_region_id;
                $region->save();

                // Success: Region created
                $this->result['status'] = 'success';
                $this->message('success', __('panel/postal_areas.txt_created'));
            }
        ...
        if ($region) {
            ...
            if (true) {
                ...
                if ($validator->fails()) {
                    ...
                    $this->result['status'] = 'success';
                    $this->message('success', __('panel/postal_areas.txt_updated'));
                }
    ...
    public function delete(Model $region){
        ...
        if ($region) {
            ...
            if (true) {
                ...
                $this->result['status'] = 'success';
                $this->message('success', __('panel/postal_areas.txt_deleted'));
