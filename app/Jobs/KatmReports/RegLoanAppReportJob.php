...
class RegLoanAppReportJob extends BaseKatmQuickReportJob
{

    protected function jobInfo(): string
    {
        return "Регистрация отчёта (001)";
    }

    protected function repeatProcess(): void
    {
        self::dispatch($this->contractID)->delay(now()->addMinute());
    }
    ...
    protected function onSuccess(): void
    {
        ...
        RepKatm::regStartReport(Contract::find($this->contractID));
    }
